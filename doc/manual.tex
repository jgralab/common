...
% Version information
\newcommand{\version}{Version 0.9 -- \today}
...
Its goal is to make the creation of build files easier than before.

This text targets users of JGraLab who want to create their own projects depending on JGraLab.
