...
public class AutoBuildID {
	...
	private final String[] info = { "Helptext", "TODO!" };
	...
	private void createLongOptions() {
		...
		longOptions[0] = new LongOpt("modify", LongOpt.REQUIRED_ARGUMENT, null,
				'm');
		longOptions[1] = new LongOpt("info", LongOpt.REQUIRED_ARGUMENT, null,
				'i');
	}
	...
	private void processArguments(String[] args) {
		...
		/*
		 * if no command line arguments are specified, create an "-i" argument
		 * inorder to invoke printInfo()
		 */
		if (args.length == 0) {
